...
(function ($) {
    ...
    var ms = $.mobiscroll,
        ...
        range = ['8:00-10:00', '10:00-12:00', '13:00-15:00', '15:00-17:00'],
             ...
             if (p.match(/custom/i)) {
                ...
                for (k = offset; k < offset + 4; k++) {
                    if (k == o.h) {
                        ...
                        w[s.hourText][0] =  '8:00-10:00';
                        w[s.hourText][1] =  '10:00-12:00';
                        w[s.hourText][2] =  '13:00-15:00';
                        w[s.hourText][3] =  '15:00-17:00';
                    } else if (k == o.i) {
                        offset++;
                        w[s.minuteText] = {};
                        for (i = 0; i < 60; i += stepM) {
                ...
                */
                validate: function (dw, i) {
                    var temp = inst.temp, //.slice(0),
                        ...
                        maxs = { y: maxd.getFullYear(), m: 11, d: 31, h: 3, i: step(59, stepM), s: step(59, stepS), a: 1 },
                        minprop = true,
                        maxprop = true;
    ...
    $.each(['date', 'time', 'datetime', 'datecustom'], function (i, v) {
        ms.presets[v] = preset;
        ms.presetShort(v);
    });
